...
public class SpeechToTextDemo : MonoBehaviour, ISpeechToTextListener
{
    ...
    private IEnumerator PrintMessageRoutine()
    {
        while (true)
        {
            // Imprime el mensaje "Hablando"
            Debug.Log("Hablando");
            SpeechText.text = "Hablando";

            // Espera 5 segundos
            yield return new WaitForSeconds(5);

            // Desactiva el mensaje (en este caso, simplemente no hace nada después de los 5 segundos)
            Debug.Log("Mensaje desactivado");
            SpeechText.text = "Mensaje desactivado";
            // Espera 25 segundos adicionales para completar los 30 segundos totales
